...
- **Layout (wireframe):** narrow **activity bar** on the far left (settings at the bottom), **main workspace** in the **center** at **3/5** width (Story / Characters / Clips / **Video** with bottom tabs), and **Agent Chat** on the **right** at **2/5** with a **Cursor-style** rounded composer: **auto-growing multiline** draft (12px text, wraps lines, no inner scrollbar; **Enter** sends, **Shift+Enter** newline).
